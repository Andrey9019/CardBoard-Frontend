...
export default function Hero() {
  return (
    <section className="mb-12 flex w-full items-center justify-center bg-[url('../../../public/images/Baner-M.png')] bg-cover bg-center px-9 py-36 text-secondary lg:bg-[url('../../../public/images/Baner-T.png')] lg:px-[154px] lg:py-40 xl:bg-[url('../../../public/images/Baner-D.png')] xl:px-[327px] xl:py-[186px]">
