...
export default function Hero() {
  return (
    <section className="bg-background text-secondary relative -top-6 mb-12 flex w-full items-center justify-center bg-[url('/images/Baner-M.png')] bg-cover bg-center px-9 py-36 lg:mb-16 lg:bg-[url('/images/Baner-T.png')] lg:px-[154px] lg:py-40 xl:bg-[url('/images/Baner-D.png')] xl:px-[327px] xl:py-[186px]">
