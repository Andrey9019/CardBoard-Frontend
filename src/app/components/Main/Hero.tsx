...
export default function Hero() {
  return (
    <section className="bg-background bg-[url('/images/Baner-M.png')] lg:bg-[url('/images/Baner-T.png')] xl:bg-[url('/images/Baner-D.png')] text-secondary mb-12 flex w-full items-center justify-center bg-cover bg-center px-9 py-36 lg:mb-16 lg:px-[154px] lg:py-40 xl:px-[327px] xl:py-[186px]">
